...
I love building and contributing to open-source projects in my free time. I also maintain a curated list of my [starred projects](https://github.com/angristan/awesome-stars).

### Projects

#### Web 🌐

My recent web projects mostly use **React**, **Effect**, and **Cloudflare Workers**, with **Go** and **Laravel** for server-side applications.

- [Pastekey](https://github.com/angristan/pastekey): Passkey-only, end-to-end encrypted text and file sharing.
- [Koliko](https://github.com/angristan/koliko): Privacy-first, self-hostable usage analytics for coding agents. It shows where agent time, tokens, and costs go without collecting prompts, responses, or source code.
- [Larafeed](https://github.com/angristan/larafeed): Web-based feed reader.
- [Gongyu](https://github.com/angristan/gongyu): A modern, self-hosted bookmark manager inspired by Shaarli.
...
- [Vélib Pulse](https://github.com/angristan/velib): A fast, map-first view of Vélib’ Métropole availability in Paris.

#### Mobile 📱

- [Netclode](https://github.com/angristan/netclode): A self-hosted coding agent with a native iOS client built in **SwiftUI**.
- [firstfm-ios](https://github.com/angristan/firstfm-ios): iOS client for Last.fm written with **Swift** and **SwiftUI**.

#### Desktop 🖥️

- [Netclode](https://github.com/angristan/netclode): A self-hosted coding agent with a native macOS client built in **SwiftUI**.
...
- [Netclode](https://github.com/angristan/netclode): A self-hosted coding environment with sessions isolated in **Kata Containers** microVMs using **Cloud Hypervisor**.
- [Codebench](https://github.com/codebench-dev/): Code benchmarking platform with **Go** workers running inside **Firecracker** microVMs.
- [krowl](https://github.com/angristan/krowl): A distributed web crawler in **Go** with durable local storage, consistent-hash sharding, and WARC capture.
...
- [palette](https://github.com/angristan/palette): Extract color palette from an image with **k-means** and **k-NN** (**OpenCV**, **scikit-learn**, **pandas**, **NumPy**).
